...
public class AppController {
	...
	@GetMapping("/viewScheduledmails")
	public String Viewmail_S(@ModelAttribute JobRequest jobRequest,Model model){
...
//return to the homepage
	...
	public String formSchedulemail(@ModelAttribute JobRequest jobRequest, Model model) {
		model.addAttribute("jobRequest", jobRequest);
		return "schedulejobsin";
	}
}